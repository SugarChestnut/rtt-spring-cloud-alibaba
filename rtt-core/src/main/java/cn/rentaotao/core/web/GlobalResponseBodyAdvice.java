package cn.rentaotao.core.web;

import cn.rentaotao.core.bean.JsonMap;
import cn.rentaotao.core.bean.JsonResult;
import cn.rentaotao.core.util.JsonUtils;
import cn.rentaotao.core.util.ServletUtils;
        ...
        if (body instanceof JsonResult || body instanceof JsonMap) {
            ...
            try {
                ...
                if (httpServletResponse != null) {
                    ServletUtils.writeJsonMessage(httpServletResponse, JsonResult.buildSuccess(body));
                    return null;
                }
            } catch (Exception e) {
            ...
            return JsonUtils.object2Json(JsonResult.buildSuccess(body));
        }
